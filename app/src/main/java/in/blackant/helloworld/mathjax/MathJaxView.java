...
import in.blackant.helloworld.R;
...
public class MathJaxView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrSet, MathJaxConfig config) {
        ...
        if (attrSet != null) {
            ...
            inputText = attrs.getString(R.styleable.MathJaxView_android_text);
            attrs.recycle();
        }
        if (config == null) {
        ...
        addView(mWebView, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, gravity));
